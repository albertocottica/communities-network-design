...
twoway (connected CDF_c_pvc pvc, sort msize(small)) (connected CDF_t_nu1_00_pvc pvc, sort msize(small)) ///
(connected CDF_t_nu1_02_pvc pvc, sort msize(small)) (connected CDF_t_nu1_04_pvc pvc, sort msize(small)) ///
(connected CDF_t_nu1_06_pvc pvc, sort msize(small)) (connected CDF_t_nu1_08_pvc pvc, sort msize(small)) ///
(connected CDF_t_nu1_10_pvc pvc, sort msize(small)), xline(.1)
...
twoway (connected CDF_c_pvc pvc, sort msize(small)) (connected CDF_t_nu2_00_pvc pvc, sort msize(small)) ///
(connected CDF_t_nu2_02_pvc pvc, sort msize(small)) (connected CDF_t_nu2_04_pvc pvc, sort msize(small)) ///
(connected CDF_t_nu1_06_pvc pvc, sort msize(small)) (connected CDF_t_nu1_08_pvc pvc, sort msize(small)) ///
(connected CDF_t_nu2_10_pvc pvc, sort msize(small)), xline(.1)
