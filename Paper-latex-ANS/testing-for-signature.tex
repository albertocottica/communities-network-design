...
\includegraphics[width=.5\linewidth]{./Pictures/PDF_fit_no_onboarding_0034}\label{fig:fit_no_onboarding}
}
}
\\
\makebox[\textwidth]{
...
\subfloat[fig:_fit_nu_1_1][]{
	\includegraphics[width=.5\linewidth]{./Pictures/PDF_fit_nu1_1_nu2_1_wob_True_0023}\label{fig:fit_nu_1_1}
}
}
