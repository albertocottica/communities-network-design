...
\subfloat[fig:_flow_example][]{
	\includegraphics[width=.5\linewidth, height=4cm]{./Pictures/PDF_fit_innovatoriPA}\label{fig:fit_innovatoriPA}
}
\subfloat[fig:_fit_no_onboarding][]{
\includegraphics[width=.5\linewidth, height=4cm]{./Pictures/YES_PDF_fit_no_onboarding_178}\label{fig:fit_no_onboarding}
}
}
\\
\makebox[\textwidth]{
\subfloat[fig:_fit_edgeryders][]{
	\includegraphics[width=.5\linewidth, height=4cm]{./Pictures/PDF_fit_edgeryders}\label{fig:fit_edgeryders}
}
\subfloat[fig:_fit_nu_1_1][]{
	\includegraphics[width=.5\linewidth, height=4cm]{./Pictures/YES-PDF_fit_onboarding_nu_1_1__429}\label{fig:fit_nu_1_1}
}
}
